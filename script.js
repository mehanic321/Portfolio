...
ОСНОВНАЯ ЭКСПЕРТИЗА (Major Experience):
...
3. Joomla! CMS:
   - Глубокое знание архитектуры MVC (компоненты, модули).
   - Переопределение шаблонов (Overrides) без правки ядра.
   - Миграция сайтов с версий 3 на 4 и 5.

ДОПОЛНИТЕЛЬНЫЙ ОПЫТ (Minor Experience):
- Webasyst (Shop-Script): Настройка витрины, мелкие правки в шаблонах Smarty, установка плагинов.
- OpenCart: Базовая поддержка, внесение правок в Twig, установка модулей через OCMOD.
        ...
        try {
            ...
            if (client) {
                ...
                const systemInstruction = `
                    ...
                    Твоя цель - "продать" Алекса работодателю или клиенту как эксперта по CMS (WordPress, Bitrix, Joomla).
                    ...
                    2. Будь кратким, уверенным и ориентированным на бизнес-пользу.
                    3. Четко различай основной опыт (WP, Bitrix, Joomla) и дополнительный (Webasyst, OpenCart). Если спрашивают про Webasyst, говори, что опыт есть, но основной фокус на других системах.
