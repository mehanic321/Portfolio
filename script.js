...
Основная ценность: Создаю готовые бизнес-решения на базе CMS (WordPress, Bitrix, OpenCart), которые экономят бюджет и легко управляются. Не просто верстаю, а интегрирую сложные системы (1C, CRM, Платежи).
Опыт: Более 3 лет коммерческой разработки и администрирования сайтов.
Стек технологий:
- CMS & E-commerce: WordPress (WooCommerce), 1C-Bitrix, OpenCart, Shopify.
- Backend: PHP 8+, MySQL, написание плагинов с нуля, работа с хуками и API.
- Frontend: HTML5, CSS3 (SCSS), jQuery, Bootstrap 5. Верстка кастомных тем без конструкторов.
- Экспертиза: Оптимизация производительности (Google PageSpeed 90+), SEO-оптимизация кода, настройка серверов (Nginx/Apache), безопасность.
Баланс навыков: Fullstack (60% Backend / 40% Frontend).
Зарплатные ожидания: $3,500/месяц или $25/час.
Обо мне: Инженер, который понимает, что бизнесу нужен не "код", а "продажи". Умею объяснять сложные вещи простым языком. Есть опыт руководства командой контент-менеджеров и джуниоров.
Проекты и Результаты:
1. Electro Market (Team Lead): E-commerce на 15к товаров. Синхронизация с 1С, ElasticSearch поиск. Рост продаж +30% за счет скорости.
2. StroyGroup Portal (Team Member): Корпоративный портал на WP. Кастомная система ролей, документооборот, интеграция с AD. Экономия бюджета $10k.
3. Luxury Estate (Solo): Каталог недвижимости. Сложные фильтры на AJAX, интеграция карт и CRM.
        ...
        try {
            ...
            if (client) {
                ...
                const systemInstruction = `
                    ...
                    3. Подчеркивай опыт кастомной разработки плагинов и оптимизации.
